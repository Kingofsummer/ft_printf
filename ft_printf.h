...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/07/30 15:01:52 by afedoren          #+#    #+#             */
/*   Updated: 2018/07/30 15:01:58 by afedoren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_print_p(char *num_p, t_struct *list, int len);
...
void			ft_printfour(wchar_t c, int len_bytes, t_struct *list);
